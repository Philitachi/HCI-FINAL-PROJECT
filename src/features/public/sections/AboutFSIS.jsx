...
const ABOUT_FSIS_VIDEO_ID = 'BCNoFNOfUyc';
const ABOUT_FSIS_EMBED_URL = `https://www.youtube.com/embed/${ABOUT_FSIS_VIDEO_ID}?autoplay=1&rel=0`;
const ABOUT_FSIS_THUMBNAIL_URL = `https://img.youtube.com/vi/${ABOUT_FSIS_VIDEO_ID}/maxresdefault.jpg`;
const ABOUT_FSIS_THUMBNAIL_FALLBACK_URL = `https://img.youtube.com/vi/${ABOUT_FSIS_VIDEO_ID}/hqdefault.jpg`;
          ...
          <div className="about-fsis-video-wrapper" ref={videoWrapperRef}>
            {isVideoPlaying ? (
              <iframe
                ...
                title="Bureau of Fire Protection: Fire Safety Information System"
              ...
              <button
                ...
                aria-label="Play Bureau of Fire Protection: Fire Safety Information System video"
              >
                <img
                  className="yt-thumbnail-image"
                  src={ABOUT_FSIS_THUMBNAIL_URL}
                  alt="Bureau of Fire Protection: Fire Safety Information System video thumbnail"
                  onError={(event) => {
                    event.currentTarget.src = ABOUT_FSIS_THUMBNAIL_FALLBACK_URL;
                  }}
                />
