      ...
      <div className="forgot-content">
        <div className="forgot-card">
          <div className="illustration-wrapper">
            <img src={illustrationDark} alt="Forgot Password" className="forgot-illustration dark-img" />
            <img src={illustrationLight} alt="Forgot Password" className="forgot-illustration light-img" />
          </div>
